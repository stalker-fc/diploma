...
\addcontentsline{toc}{subsection}{Разработка математической библиотеки}
...
%\lstinputlisting[language=Python]{implementation/listing/math/calculate.py}

%\lstinputlisting[language=Python]{implementation/listing/math/model.py}

%\lstinputlisting[language=Python]{implementation/listing/math/configuration.py}
